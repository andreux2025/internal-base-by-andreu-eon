...
#pragma warning(suppress: 4244)
	...
	public:
		...
		inline TEnumAsByte(TEnum _value)
			: value(static_cast<uint8_t _t>(_value))
		{
		}
		...
		explicit inline TEnumAsByte(uint8_t _t _value)
			: value(_value)
		{
		}
...
struct FString : private TArray<wchar_t>
{
	...
	FString(const wchar_t* Other)
	{
		this->Max = this->Count = *Other ? static_cast<int>(NoCRT::__wcslen(Other)) + 1 : 0;
